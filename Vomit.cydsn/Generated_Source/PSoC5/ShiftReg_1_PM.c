...
void ShiftReg_1_SaveConfig(void) 
{
    ...
    ShiftReg_1_backup.saveSrA0Reg   = CY_GET_REG32(ShiftReg_1_SHIFT_REG_LSB_PTR);
    ShiftReg_1_backup.saveSrA1Reg   = CY_GET_REG32(ShiftReg_1_SHIFT_REG_VALUE_LSB_PTR);
...
void ShiftReg_1_RestoreConfig(void) 
{
    ...
    CY_SET_REG32(ShiftReg_1_SHIFT_REG_LSB_PTR, ShiftReg_1_backup.saveSrA0Reg);
    CY_SET_REG32(ShiftReg_1_SHIFT_REG_VALUE_LSB_PTR, ShiftReg_1_backup.saveSrA1Reg);
