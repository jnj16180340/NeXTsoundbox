...
/* Interrupt constants */
#if defined(USBFS_1_Dp__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
     ...
     *  @{
     */
        #define USBFS_1_Dp_INTR_NONE      (uint16)(0x0000u)
        #define USBFS_1_Dp_INTR_RISING    (uint16)(0x0001u)
        #define USBFS_1_Dp_INTR_FALLING   (uint16)(0x0002u)
        #define USBFS_1_Dp_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define USBFS_1_Dp_INTR_MASK      (0x01u) 
#endif /* (USBFS_1_Dp__INTSTAT) */
...
/* SIO registers */
#if defined(USBFS_1_Dp__SIO_CFG)
    #define USBFS_1_Dp_SIO_HYST_EN        (* (reg8 *) USBFS_1_Dp__SIO_HYST_EN)
    #define USBFS_1_Dp_SIO_REG_HIFREQ     (* (reg8 *) USBFS_1_Dp__SIO_REG_HIFREQ)
    #define USBFS_1_Dp_SIO_CFG            (* (reg8 *) USBFS_1_Dp__SIO_CFG)
    #define USBFS_1_Dp_SIO_DIFF           (* (reg8 *) USBFS_1_Dp__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define USBFS_1_Dp_0_INTTYPE_REG 		(* (reg8 *) USBFS_1_Dp__0__INTTYPE)
#endif /* (USBFS_1_Dp__INTSTAT) */
