...
*
* \funcusage
*  \snippet CLOCKPIN_SUT.c usage_CLOCKPIN_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet CLOCKPIN_SUT.c usage_CLOCKPIN_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet CLOCKPIN_SUT.c usage_CLOCKPIN_Read  
*******************************************************************************/
...
* preferred CLOCKPIN_Read() API because the 
* CLOCKPIN_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet CLOCKPIN_SUT.c usage_CLOCKPIN_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: CLOCKPIN_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use CLOCKPIN_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - CLOCKPIN_0_INTR       (First pin in the list)
    *  - CLOCKPIN_1_INTR       (Second pin in the list)
    *  - ...
    *  - CLOCKPIN_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet CLOCKPIN_SUT.c usage_CLOCKPIN_SetInterruptMode
    *******************************************************************************/
    void CLOCKPIN_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & CLOCKPIN_0_INTR) != 0u) 
		{ 
			 CLOCKPIN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet CLOCKPIN_SUT.c usage_CLOCKPIN_ClearInterrupt
    *******************************************************************************/
