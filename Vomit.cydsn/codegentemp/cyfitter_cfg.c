...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000238u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_FASTCLK_PLL_P), 0x010Au);
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_CR), 0x02u);
...
void cyfitter_cfg(void)
{
	...
	ClockSetup();
	/* Set Flash Cycles based on newly configured 25.00MHz Bus Clock. */
