...
{
    CY_SET_REG32(ShiftReg_1_SHIFT_REG_LSB_PTR, shiftData);
}
    ...
    *******************************************************************************/
                                                                         ...
                                                                         
    {
        ...
        {
            CY_SET_REG32(ShiftReg_1_IN_FIFO_VAL_LSB_PTR, shiftData);
    ...
    *******************************************************************************/
    ...
    {
        return(CY_GET_REG32(ShiftReg_1_OUT_FIFO_VAL_LSB_PTR));
    }
...
uint32 ShiftReg_1_ReadRegValue(void) 
{
    ...
    {
        (void) CY_GET_REG32(ShiftReg_1_OUT_FIFO_VAL_LSB_PTR);
    }
